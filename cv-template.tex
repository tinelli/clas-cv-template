...
\iftoggle{internal}{
% Adds contrib option to bibtex files
\makeatletter
...
%% This subsection should contain non-refereed publications that are only available
%% in electronic form. Examples include edited electronic proceedings and
%% arxiv reports (not associated to a journal publication).
